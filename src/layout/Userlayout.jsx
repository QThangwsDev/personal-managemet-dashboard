...
function Userlayout() {
  ...
  return (
    <div className='w-full h-full bg-amber-900 text-white flex overflow-hidden'>
        <aside className={`w-${collapse?60:20} h-full bg-[#40240E] transition-all duration-200 ease-in-out`}>
            {/* logo va ten app */}
            ...
            <button className='p-2 bg-amber-300 rounded-2xl' onClick={() =>setCollapse(prev => !prev)}>dong</button>
        </aside>
        {/* noi dung hien thi */}
